...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientCompany'] = "alRzaLIbIfrRNPDKudQg";
        $headers['auth']['clientSecret'] = "NzExNWFsUnphTEliSWZyUk5QREt1ZFFnY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
